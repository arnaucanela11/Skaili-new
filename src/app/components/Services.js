...
const services2 = [
  ...
  "Fast loading",
  "Domain and hosting management and SSL certificate",
  "Ideal for low complex websites",
];
          ...
          <div className="services__main__div">
            ...
            <div className="services__targets__div">
              <div className="services__target__1">
                <Image className="services__rocket__image" src={Rocket}></Image>
                ...
                <span className="services__ideal__span">Ideal for <span className="text-[#1F3C88]">mid/high</span> complex websites</span>
                <div className="services__averages__div">
                  <div className="services__average__price">Average price: <span className="font-semibold">350€</span></div>
                  <div className="services__average__time">Average time: <span className="font-semibold">11 days</span></div>
                </div>
              </div>
              <div className="services__target__2">
                <Image className="services__PC__image" src={PCServices}></Image>
                <div className="services__target__titles__div">
                  <span className="services__target__subtitle">
                    Web Development
                  </span>
                  <h2 className="services__target__title">
                    ...
                    CSM (<span className="underline">no code</span> tools){" "}
                ...
                <span className="services__ideal__span">Ideal for <span className="text-[#1F3C88]">low</span> complex websites</span>
                <div className="services__averages__div">
                  <div className="services__average__price">Average price: <span className="font-semibold">200€</span></div>
                  <div className="services__average__time">Average time: <span className="font-semibold">8 days</span></div>
                </div>
              </div>
              <div className="services__target__3">
                ...
                <div className="services__averages__div mt-2">
                  <div className="services__average__price">Average price: <span className="font-semibold">100€</span></div>
                  <div className="services__average__time">Average time: <span className="font-semibold">4 days</span></div>
                </div>
              </div>
            </div>
          </div>
